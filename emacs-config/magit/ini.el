...
;; Treemacs for find symbols
(use-package lsp-treemacs
  :after lsp)

;; Configuring Server for Python
(use-package python
  :ensure nil
...
;;Quicker Symbols search with lsp-ivy
;; (use-package lsp-ivy) ;; Maybe later xD

;; Company MODE for more smart code completion
(use-package company
  :after lsp-mode
  ...
  (company-idle-dleay 0.0))

;; Improving the company mode interface
